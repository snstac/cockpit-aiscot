...
export const Application: React.FC = () => {
    ...
    return (
        <div data-testid="aiscot-app">
            ...
            >
                ...
                <CardExpandableContent>
                    ...
                    <form onSubmit={handleEnvVarFormSubmit}>
                        <div className="aiscot-config-form-layout" data-testid="aiscot-config-form-layout">
                            <div className="aiscot-config-body-scroll" data-testid="aiscot-config-scroll">
                            ...
                            <div className="aiscot-config-actions">
                                <Checkbox
                                id="aiscot-save-restart"
                                label={_('Restart aiscot after save')}
            ...
            <Card className="aiscot-expandable-card" isExpanded={isDebugExpanded}>
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsDebugExpanded(!isDebugExpanded)}
                    toggleButtonProps={{
                        id: 'aiscot-debug-expand',
            ...
            <Card className="aiscot-expandable-card" isExpanded={isAdvancedExpanded}>
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsAdvancedExpanded(!isAdvancedExpanded)}
                    toggleButtonProps={{
                        id: 'aiscot-advanced-expand',
