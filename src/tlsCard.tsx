...
/** Canonical TLS directory; readable by aiscot system user. */
export const TLS_DIR = '/etc/aiscot/tls';

const KEY_USER = 'aiscot';
...
export function TlsUploadCard({ onToast, onInstalledPaths }: TlsUploadCardProps) {
    ...
    return (
        <Card
            ...
            data-testid="aiscot-tls-card"
        >
            <CardHeader
                className="ct-card-expandable-header"
                onExpand={() => setExpanded(!expanded)}
                toggleButtonProps={{
                    id: 'aiscot-tls-expand',
