# cockpit-aiscot — AIS vessel tracking for TAK, in your browser

A [Cockpit](https://cockpit-project.org/) web console plugin for
[AISCOT](https://github.com/snstac/aiscot), the **AIS to TAK gateway**. Track
...
control, `/etc/default/aiscot` configuration, TAK TLS certificates, and live status —
no SSH required.
